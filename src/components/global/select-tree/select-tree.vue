...
<template>
  <div>
    ...
    >
      ...
      <el-row>
        <el-button class="select-tree-ok" @click="isShowSelect=false" size="mini">确定</el-button>
        <el-button v-if="isResetShow&&multiple" class="select-tree-reset" @click="resetting" size="mini">重置</el-button>
      </el-row>
    </el-popover>
  </div>
</template>
